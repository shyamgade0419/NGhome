...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Tap any request to open its conversation. You\'ll see everything the society has said, and you can reply — add a photo description, answer a question, or say it\'s still happening.',
      'You get a notification when the status changes or when someone replies, so there\'s no need to keep checking.',
    ],
    tip: 'Only you and the society\'s staff can see your request and its conversation — not other residents. Once a request is closed, raise a new one if the problem comes back.',
  },
  {
    id: 'helpdesk-reply',
    icon: '💬',
    title: 'Replying to residents on a request',
    summary: 'Talk a request through with the resident who raised it.',
    audience: 'admin',
    steps: [
      'Go to Helpdesk and tap "Conversation" on any request.',
      'Read what the resident has said, then type your reply and send it. They get a notification straight away.',
      'Use "Update status" separately when the work actually moves on — replying never changes the status by itself.',
      'When a resident replies, the person assigned to the request is notified. If nobody is assigned, the society admins are.',
    ],
    tip: 'Assigning a request to a staff member means their replies reach the right person, instead of every admin being notified.',
  },
  {
    id: 'announcements',
    icon: '📢',
