...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    tip: 'This can only be done once per event, and it\'s a real financial action — double-check the amount before confirming. To correct it afterward, edit the expense directly under Accounts.',
  },
  {
    id: 'notifications',
    icon: '🔔',
